...
SOURCES += core/src/apu_pwm.c
SOURCES += core/src/apu_lfsr.c
SOURCES += core/src/apu_wave.c
...
HEADERS += core/include/apu_pwm.h
HEADERS += core/include/apu_lfsr.h
HEADERS += core/include/apu_wave.h
HEADERS += core/include/apu_common.h
...
OBJS += objects/core/apu_pwm.o
OBJS += objects/core/apu_lfsr.o
OBJS += objects/core/apu_wave.o
